                        ...
                        if (res.status) {
                            ...
                            setTimeout(function () {
                                                ...
                                                locations.forEach(function (item) {
                                                    if ($('.hh-map-price[data-id="' + item.post_id + '"]', base.search_container).length === 0) {
                                                        let popup = new mapboxgl.Popup({
                                                            ...
                                                            .setHTML('<div class="hh-map-popup" id="map_image_popup_' + item.post_id + '" style="display:none;">' +
                                                                '<div class="thumb" style="display:flex; justify-content: center;"><a href="' + item.url + '"><img src="' + item.thumbnail + '" alt="' + item.title + '" style="widht: 250px; height: 200px;"/></a></div><div class="content"><a href="' + item.url + '" class="mt-2 text-center" style="font-size: 15px">' + item.title + '</a><p class="text-center">from ' + item.price + '</p></div>' +
                                                                '</div><div style="cursor:pointer" class="hh-map-price" data-id="' + item.post_id + '"><img src="/images/home_icon.svg" style="width:30px; height: 30px;"/></div>')
                                ...
                                $('.hh-map-price').click(function () {
                                    let locations = res.locations;
                                    var tt = $(this);
                                    var id = tt[0].dataset.id;
                                    locations.forEach(function (item){
                                        if(item.post_id != id) {
                                            $("#map_image_popup_" + item.post_id).css("display", "none");
                                        }else {
                                            $("#map_image_popup_" + item.post_id).removeAttr("style");
                                        }
                                    ...
                                    $("#map_image_popup_" + id).removeAttr("style");
                                });
