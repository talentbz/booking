...
class CommentAgent extends Model
{
    protected $table = 'comments_agent';
    ...
    public function getCommentByID($agent_id, $data)
    {
        $default = [
            'page' => 1,
            'parent' => 0,
        ...
        $post = DB::table($this->getTable())->selectRaw("SQL_CALC_FOUND_ROWS comments_agent.*")
    ...
    public function getCommentCountByID($agent_id, $type = 'post')
    {
