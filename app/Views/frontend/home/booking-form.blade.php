...
<form class="form-action" action="{{ url('add-to-cart-home') }}" method="post" data-loading-from=".form-body"
    ...
    @if($post->booking_type == 'per_night')
        ...
        <div class="form-group">
            <div class="row check-in-out-render">
                <div class="col-sm-6">
                    <label for="checkinout" style="font-size: 18px; font-weight: bolder;">{{ __('Check-in') }}</label>
                    <p class="check-in-render_tmp" style="width:100%; border: 1px solid #e2e2e2; border-radius: 5px; padding: 15px; cursor: pointer;"
                    data-date-format="DD.MM.YYYY."></p>
                </div>
                <div class="col-sm-6">
                    <label for="checkinout" style="font-size: 18px; font-weight: bolder;">{{ __('Check-out') }}</label>
                    <p class="check-out-render_tmp" style="width:100%; border: 1px solid #e2e2e2; border-radius: 5px; padding: 15px; cursor: pointer;"
                    data-date-format="DD.MM.YYYY."></p>
                </div>
            </div>
        </div>
