        ...
        <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
                <div class="payment-item">
                    ...
                    <div class="payment-detail" style="display: flex; ">
                        <div>
                            ...
                            <div class="item d-flex align-items-center">
                                ...
                                <span class="ml-4">
                                    ...
                                    $paymentID = $bookingObject->payment_type ==='wspay' ? 'Credit Cards' : $bookingObject->payment_type;
                    ...
                    <div class="payment-customer-info">
                        ...
                        <div class="item">
                            <?php 
                                //$desc = get_payments($bookingObject->payment_type)::getDescription();
                                $desc = $bookingObject->payment_type;
                            ?>
                           {{-- <span>{{__('Payment Detail')}}</span> --}}
                            <span>{{--  balanceTags(nl2br($desc)) --}}</span> 
                        </div>
                    </div>
