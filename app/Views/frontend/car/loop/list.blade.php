...
<div class="hh-service-item home list" data-lng="{{ $item->location_lng }}" style="width:100%;"
        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center">
                @if(enable_review())
                    <div class="rating">
                        <?php
                        $review_number = get_comment_number($item->post_id, 'car');
                        if ($review_number > 0) {
            ...
            <div style="display:flex; justify-content:space-between">
                <h3 class="title" style="font-size: 36px;font-weight:bolder; margin-bottom: 5px;">
                    <a href="{{ $url }}">{{ get_translate($item->post_title) }}</a>
                </h3>
                <div style="display: flex; justify-content: center; align-items:center; text-align: center; border: 2px solid #115571; padding: 5px 10px 4px 10px; border-radius: 5px; color: #115571;min-width: 105px;">
                    <div>
                        ...
                        <p class="unit" style="font-weight:bolder; font-size: 14px;margin-bottom: 0px;">Per {{get_car_unit($item)}}</p>
                    </div>
                </div>
            </div>
