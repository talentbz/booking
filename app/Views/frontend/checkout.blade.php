                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    ?>
                                                    <!-- <input list="brow" class="form-control wide" >
                                                        <datalist id="brow">
                                                            <option value="">{{__('---- Select ----')}}</option>
                                                            @foreach($countries as $key => $value)
                                                                <option value="{{ $key }}"><?php echo $value['flag24']; ?>{{ $value['name'] }}</option>
                                                            @endforeach
                                                        </datalist>  -->
                                                    <select name="country" id="cc-country" class="form-control wide">
                                                        <option value="">{{__('---- Select ----')}}</option>
                                                        @foreach($countries as $key => $value)
                                                            <option value="{{ $key }}" data-icon="{{ $value['flag24'] }}"><?php echo $value['flag24']; ?>{{ $value['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane relative" id="co-payment-selection">
                                    <form id="checkout-payment-info" action="{{ url('checkout') }}"
                                        ...
                                        <div class="payment-gateways">
                                            ...
                                            @if(Setting::main()->wspay_enable=="true")
                                             <div class="payment-item payment-wspay">
                                                <div
                                                    class="radio radio-success mb-1 mb-md-3 d-flex align-content-center">
                                                    <input id="payment-wspay"
                                                           class="payment-method"
                                                           type="radio" name="payment"
                                                           value="wspay">
                                                    <label for="payment-wspay">Wspay</label>
                                             </div>
                                             @endif
                                        </div>
