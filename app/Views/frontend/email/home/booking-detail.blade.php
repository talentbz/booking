        ...
        <div class="booking-detail">
            ...
            @if($for == 'customer')
                <div class="item client-info">
                    <span class="title" style="font-weight: bold;">{{__('AGENT DETAILS:')}}</span>
                    <?php
                    $partner_data = get_user_by_id($booking->owner);
                    ?>
                    <span class="info">
                        <p>{{ $partner_data->first_name }} {{ $partner_data->last_name }}</p>
                        <p>{{ $partner_data->email }}</p>
                        <p>{{ $partner_data->mobile }}</p>
                        <p>{{get_translate($service_data->location_address)}} {{ get_short_address($service_data) }} | Longitude: {{$service_data->location_lng}} |  Lattitude: {{$service_data->location_lat}}</p>
                    </span>
                </div>
                <div class="item client-info">
