...
<div class="hh-email-wrapper">
    ...
    <div class="content-email">
        ...
        <div class="booking-detail">
            <p>Bellow you can find some additional offer that I think it could be interested to you:
                <strong><a href="https://salmaretravel.agency/{{$service_type}}/{{$serviceObject->post_id}}/{{$serviceObject->post_slug}}">{{get_translate($serviceObject->post_title)}}</a></strong>
            </p>
            <p>
                If you have any questions regarding this offer you can contact me at any time
            </p>
