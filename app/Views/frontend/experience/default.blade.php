...
?>
<div class="single-page single-experience pb-5" style="background: #F9F9F9">
    <div class="container">
    ...
    <!-- Gallery -->
        ...
        <div class="row mt-5 pr-1 pl-1" style="background: #fff; border-radius:13px; box-shadow: 7px 4px 19px 1px #f7f1f1;">
