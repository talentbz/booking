...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            ...
            {{--Start Content--}}
            <div id="message" style="background: #fff; padding: 20px; margin-bottom: 10px;">
                <p style="font-weight: bold; font-size: 15px">Uvjeti isplate vlasniku</p>
                <p>Agencija će cjelokupan iznos rezervacije isplatiti Iznajmljivaču na žiro račun najkasnije treći radni dan od dana ulaska gosta u Iznajmljivačevu smještajnu jedinicu, odnosno od trenutka kada gost potvrdi da stvarno stanje smještajne jedinice odgovara podacima na oglasu preko kojeg je rezervacija izvršena.</p>
                <p>Navedeni iznos će biti umanjen za ugovorenu agencijsku proviziju tj. rabat.</p>
                <p>Uplata cjelokupnog iznosa predstavlja i konačnu potvrdu rezervacije.</p>
                <p>Sve isplate Agencije prema Iznajmljivaču vršiti će se u eurima.</p>
                <p>Iznajmljivač se obvezuje na vrijeme dostaviti Agenciji podatke o otvorenom žiro računu na koji će se isplaćivati rezervacije. </p>
            </div>
            <?php
                    ...
                    <div class="d-none d-sm-block col-sm-6 col-md-6 col-xl-3">
                        <div class="card-box card-balance">
                            <!-- <i class="fa fa-info-circle float-right" data-toggle="tooltip"
                               ...
                               @if ($agent == 0)
                               <h4 class="mt-0 font-16">{{__('Nothing agent')}}</h4>
                               @else
                               <h4 class="mt-0 font-16">Vaš agent: {{get_username($agent)}}</h4>
                               <h4 class="mt-0 font-16">Email: {{$agentInfo->email}}</h4>
                               <h4 class="mt-0 font-16">Phone: {{$agentInfo->mobile}}</h4>
                               @endif
