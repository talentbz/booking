...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
                                            ...
                                            <div class="quick-action-links d-none d-md-block">
                                                ...
                                                @if($item->status != 'trash')
                                                    ...
                                                    <a class="quick-link-item" href="javascript:void(0)"
                                                        data-params="{{ base64_encode(json_encode($data)) }}"
                                                        data-toggle="modal" data-target="#hh-gallery-order-modal">
                                                        {{ __('Gallery Order') }}
                                                    </a>
                                                    @if($item->status == 'publish')
                                                        ...
                                                        <!-- <a class="quick-link-item" href="javascript:void(0)"
                                                            data-params="{{ base64_encode(json_encode($data)) }}"
                                                            data-toggle="modal" data-target="#hh-send-offer-modal">
                                                            {{ __('Send Offer') }}
                                                        </a> -->
                                                    @endif
                                                @endif
                                    ...
                                    <div class="dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @foreach($service_status_info as $key => $status)
                                                @if($status['name'] != 'Request Trash' && $status['name'] != 'Request Delete')
                                                    @if(is_owner())
            ...
            @include('dashboard.components.gallery-order-modal')
            {{--End content--}}
