                                ...
                                <td class="align-middle text-center">
                                    <div class="dropdown dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            $allStatus = booking_status_info();
                                            foreach ($allStatus as $key => $status) {
                                            if($key != 'request canceled' && $key != 'request refunded') {
                                                $data = [
                                                    'bookingID' => $ID,
                                                    'bookingEncrypt' => hh_encrypt($ID),
                                                    'status' => $key
                                            ...
                                            <a class="dropdown-item"
                                               data-toggle="modal"
                                               data-target="#modal-request-booking-review"
                                               data-params="{{ base64_encode(json_encode($data)) }}"
                                               href="javascript: void(0)">{{__('Request review & tip')}}</a>
                                            @endif
                                        </div>
                                    </div>
                                </td>
...
<div class="modal fade hh-get-modal-content" id="modal-request-booking-review" tabindex="-1" role="dialog"
     aria-hidden="true" data-url="{{ dashboard_url('request-booking-review') }}">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form form-action relative"
                  action="{{ dashboard_url('send-request-booking-review') }}">
                @include('common.loading')
                <div class="modal-header">
                    <h4 class="modal-title">{{__('Request review & tip')}}</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×
                    </button>
                </div>
                <div class="modal-body">
