...
<div class="form-group">
    ...
    <select class="form-control" name="term_item_type" id="term_item_type">
        <option value="1" @if($termObject->term_item_type == '1') selected' @endif>Car</option>
        <option value="2" @if($termObject->term_item_type == '2') selected @endif>Boat</option>
    </select>
</div>
