        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="col">
                            <div class="radio radio-success">
                                <input type="radio"
                                       ...
                                       id="type_of_bulk_custom" @if(is_owner()) checked @endif>
                                <label for="type_of_bulk_custom">{{ __('Add Price') }}</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="radio radio-success">
                                ...
                                <label for="type_of_bulk_discount">{{ __('Special Offer') }}</label>
                            </div>
                        </div>
                        @endif
                    </div>
                ...
                <div id="setting-days_of_custom_bulk" class="form-group field-select2_multiple has-validation"
                    ...
                    <label for="days_of_custom_bulk">{{ __('Start Date') }} <span class="text-muted f11">({{ __('Select rent Start date') }})</span></label>
                    ...
                    <label for="days_of_custom_bulk">{{ __('End Date') }} <span class="text-muted f11">({{ __('Select rent End date') }})</span></label>
                    <input type="text" class="form-control"
                        data-plugin="datepicker"
                        data-date-format="d.m.Y."
                        data-min-date="{{ date('d.m.Y.')}}"
