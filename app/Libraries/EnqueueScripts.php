...
class EnqueueScripts
{
    ...
    public function _registerScripts()
    {
        ...
        $this->addScript('country-js', asset('js/country.js'));
        ...
        $this->addScript('inbox-js', asset('mail/app.js'));
        $this->addStyle('inbox-app-css', asset('mail/app.css'));
        $this->addStyle('inbox-all-css', asset('mail/all.css'));

        $this->addScript('agent-tip-js', asset('js/agent-tip.js'));
        $this->addScript('checkout-js', asset('js/checkout.js'));
