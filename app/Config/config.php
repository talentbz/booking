...
return [
    ...
    'service_status' => [
        ...
        'request_trash' => [
            'name' => awe_lang('Request Trash')
        ],
        'delete_request' => [
            'name' => awe_lang('Request Delete')
        ]
    ],
    'payout_status' => [
        'pending' => [
    ...
    'booking_status' => [
        ...
        'request canceled' => [
            'label' => awe_lang('Request Canceled'),
            'icon' => 'fe-x-circle',
            'payment_text' => awe_lang('Your payment has been request canceled')
        ],
        'request refunded' => [
            'label' => awe_lang('Request Refunded'),
            'icon' => 'fe-x-circle',
            'payment_text' => awe_lang('Your payment has been request refunded')
        ],
    ],
    'user_roles' => [
    ...
    'superadmin_menu' => [
        ...
        [
            'type' => 'parent',
            'label' => awe_lang('Cars and Boats'),
            'service' => 'car',
            'icon' => '003_steering_wheel',
            'child' => [
                [
                    'type' => 'item',
                    'label' => awe_lang('Add new Car and Boat'),
                    'screen' => 'add-new-car',
                ],
                [
                    'type' => 'item',
                    'label' => awe_lang('My Cars and Boats'),
                    'screen' => 'my-car',
                ],
                [
                    'type' => 'hidden',
                    'label' => awe_lang('Edit Cars and Boat'),
                    'screen' => 'edit-car',
                ],
                [
                    'type' => 'item',
    ...
    'home_settings' => [
        ...
        'fields' => [
            ...
            [
                ...
                'type' => 'permalink',
                'post_type' => 'home',
                'permission' => ['administrator', 'superadmin', 'partner'],
                'section' => 'detail_options'
            ],
            [
                'id' => 'post_content',
            ...
            [
                'id' => 'post_description',
                'label' => awe_lang('Short Description'),
                'type' => 'textarea',
                'translation' => true,
                'section' => 'detail_options'
            ],
            ...
            [
                ...
                'type' => 'select',
                'layout' => 'col-12 col-md-6',
                'permission' => ['administrator', 'superadmin', 'partner'],//['administrator', 'partner', 'customer']
                'break' => true,
                'style' => 'wide',
                'section' => 'detail_options'
            ],
            [
                ...
                'choices' => [
                    ...
                    'instant_enquiry' => awe_lang('INSTANT AND INQUIRY')
                ],
                'std' => 'instant_enquiry',
                'layout' => 'col-12 col-md-6',
                'section' => 'detail_options'
            ...
            [
                'id' => 'pool_size',
                'label' => awe_lang('Swimming Pool Size (m2)'),
                'type' => 'text',
                'std' => 0,
                'validation' => 'required',
                'layout' => 'col-12 col-md-6',
            ...
            [
                'id' => 'cancellation_field',
                'label' => awe_lang('Pricing policies & Rules'),
                'type' => 'textarea',
                'translation' => true,
                'section' => 'pricing_options'
            ],
            ...
            [
                'id' => 'gallery_url',
                'label' => awe_lang('Gallery files'),
                'desc' => awe_lang('dropbox or Onedrive and etc'),
                'type' => 'text',
                'section' => 'gallery_options'
            ],
            [
            ...
            [
                'id' => 'tiktok',
                'label' => awe_lang('Tik Tok'),
                'desc' => awe_lang('Tik Tok video ...'),
                'type' => 'text',
                'section' => 'gallery_options'
            ],
            [
            ...
            [
                'id' => 'enable_rules',
                'label' => awe_lang('Enable Rules'),
                'type' => 'on_off',
                'section' => 'policies_options'
            ],
            [
                'id' => 'rules_option1',
                'label' => awe_lang('OPCIJA 1'),
                'type' => 'on_off',
                'layout' => 'col-12 col-md-6',
                'condition' => 'enable_rules:is(on)',
                'section' => 'policies_options'
            ],
            [
                'id' => 'rules_option2',
                'label' => awe_lang('OPCIJA 2'),
                'type' => 'on_off',
                'layout' => 'col-12 col-md-6',
                'condition' => 'enable_rules:is(on)',
                'section' => 'policies_options'
            ...
            [
                'id' => 'rules_detail1',
                'label' => awe_lang('Tekst pravila opcije 1'),
                'type' => 'termrules1',
                'translation' => true,
                'condition' => 'rules_option1:is(on)',
                'section' => 'policies_options'
            ],
            [
                'id' => 'rules_detail2',
                'label' => awe_lang('Tekst pravila opcije 2'),
                'type' => 'termrules2',
                'translation' => true,
                'condition' => 'rules_option2:is(on)',
                'section' => 'policies_options'
            ],
            [
                'id' => 'alert_per_hour',
            ...
            [
                'id' => 'custom_booked',
                'label' => awe_lang('Custom Booked / Availability'),
                'desc' => awe_lang('You can change booked date, availability by period...'),
                'type' => 'custom_booked',
                'post_type' => 'home',
                'section' => 'availability_options'
            ],
    ...
    'theme_options' => [
        ...
        'fields' => [
            ...
            [
                'id' => 'sub_blog_content',
                'label' => awe_lang('Sub Blog Content'),
                'type' => 'textarea',
                'layout' => 'col-12 col-md-6',
                'translation' => true,
                'break' => true,
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'id' => 'content',
                        'label' => awe_lang('Destination Content'),
                        'type' => 'textarea'
                    ],
                    [
                        'id' => 'image',
            ...
            [
                'id' => 'term_rules_1',
                'label' => awe_lang('Rules Detail 1 Croatia version'),
                'desc' => awe_lang('This field is affect to home detail in the enable rules'),
                'type' => 'textarea',
                'layout' => 'col-12 col-md-6',
                'break' => true,
                'section' => 'advance_options'
            ...
            [
                'id' => 'term_rules_en_1',
                'label' => awe_lang('Rules Detail 1 English version'),
                'desc' => awe_lang('This field is affect to home detail in the enable rules'),
                'type' => 'editor',
                'layout' => 'col-12 col-md-6',
                'translation' => true,
            ...
            [
                'id' => 'term_rules_2',
                'label' => awe_lang('Rules Detail 2 Croatia version'),
                'desc' => awe_lang('This field is affect to home detail in the enable rules'),
                'type' => 'textarea',
                'layout' => 'col-12 col-md-6',
                'break' => true,
            ...
            [
                'id' => 'term_rules_en_2',
                'label' => awe_lang('Rules Detail 2 English version'),
                'desc' => awe_lang('This field is affect to home detail in the enable rules'),
                'type' => 'editor',
                'layout' => 'col-12 col-md-6',
                'translation' => true,
